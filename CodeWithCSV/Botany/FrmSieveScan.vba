...
On Error GoTo Err_cmdgofirst_Click
    ...
    DoCmd.GoToControl Forms![frmSieveScan]![FrmSubSieveScanning].Name
...
If Me![FrmSubSieveScanning].Form![Flot Number] <> "" Then
    openarg = Me![FrmSubSieveScanning].Form![Flot Number]
Else
    openarg = Null
End If

DoCmd.OpenForm "FrmBasicData", acNormal, , , , , openarg
DoCmd.Close acForm, "FrmSieveScan"
Exit Sub
...
On Error GoTo Err_cmdgonew_Click
    ...
    DoCmd.GoToControl Forms![frmSieveScan]![FrmSubSieveScanning].Form![Flot Number].Name
...
On Error GoTo err_Output
    ...
    If Me![FrmSubSieveScanning].Form![Flot Number] <> "" Then
        DoCmd.OpenForm "FrmPopDataOutputOptions", acNormal, , , , acDialog, "Bot: SieveScanning;" & Me![FrmSubSieveScanning].Form![Flot Number]
    Else
...
If Me!FrmSubSieveScanning.Form.DefaultView = 2 Then
...
If Me!tglDataSheet = True Then
    Me!FrmSubSieveScanning.SetFocus
    'Me!FrmSubBasicData.Form![cboOptions].Visible = True
