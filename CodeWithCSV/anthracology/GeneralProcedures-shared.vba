...
DoCmd.OpenForm "Anthracology: Main", acNormal, , , acFormReadOnly 'open main menu

'refresh the main menu so the version number appears - REPLACE WITH YOUR MENU NAME
Forms![Anthracology: Main].Refresh
   ...
   '' myrs.Open sql, CurrentProject.Connection, adOpenKeySet, adLockOptimistic
    ...
    If Not (myrs.BOF And myrs.EOF) Then
        ...
        If CDbl(centralver) <> CDbl(theVersionNumberLocal) Then
            Dim msg
            msg = "There is a new version of the Anthracology database file available. " & Chr(13) & Chr(13) & _
                    "Please close this copy now and run 'Update Databases.bat' on your desktop or " & _
                    "copy the file 'Anthracology Central Database.mdb' from G:\" & Year(Date) & " Central Server Databases " & _
                    ...
                    "DO NOT DO THIS IS YOU HAVE SAVED ANY NEW QUERIES INTO YOUR DESKTOP COPY OF THE DATABASE."
...
'        tempVal = "RO"
'    ElseIf InStr(usr, "ADMIN") <> 0 Or usr = "RICH" Or usr = "MIA" Or usr = "SHAHINA" Or usr = "SARAH" Or usr = "dominik" Then
'        tempVal = "ADMIN"
