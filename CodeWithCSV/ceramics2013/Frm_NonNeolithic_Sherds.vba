...
Private Sub cmdUnitSummary_Click()

On Error GoTo err_cmdUnitSummary

    'DoCmd.OpenForm "Frm_pop_NonNeolithicSummary", acFormDS, , "SELECT * FROM dbo_Ceramics_NonNeolithic_Sherds_2013 WHERE Unit = " & Me![txtUnit] & ";"
    'DoCmd.Maximize
' SELECT dbo_Ceramics_NonNeolithic_Sherds_2013.Unit, dbo_Ceramics_NonNeolithic_Sherds_2013.Period, dbo_Ceramics_NonNeolithic_Sherds_2013.Count, dbo_Ceramics_NonNeolithic_Sherds_2013.Weight FROM dbo_Ceramics_NonNeolithic_Sherds_2013 WHERE (dbo_Ceramics_NonNeolithic_Sherds_2013.Unit="& Me![txtUnit] &")";
    DoCmd.OpenForm "Frm_pop_NonNeolithicSummary", acFormDS, , "Unit=" & [Forms]![Frm_NonNeolithic_Sherds]![txtUnit]
...
Err_go_next_Click:
    If Err.Number = 2105 Then
        MsgBox "Entry for Period in this Unit already exists"
    Else
