...
'    And (Me![cboPeriod] = "" Or IsNull(Me![cboPeriod])) Then
    ...
    'If (Me![txtUnit] = "" Or IsNull(Me![txtUnit])) Then
        ...
        Me![txtUnit].Locked = False
        Me![txtUnit].BackColor = 16777215
        Me![frm_sub_nonneolithic_2013].Enabled = True
        Me![frm_sub_nonneolithic_2013].Locked = False
        Me![frm_sub_nonneolithic_2013].BackColor = 16777215
    Else
        'existing entry lock
        Me![txtUnit].Enabled = False
        Me![txtUnit].Locked = True
        Me![txtUnit].BackColor = Me.Section(0).BackColor
        Me![frm_sub_nonneolithic_2013].Enabled = False
        Me![frm_sub_nonneolithic_2013].Locked = True
        Me![frm_sub_nonneolithic_2013].BackColor = Me.Section(0).BackColor
    End If
