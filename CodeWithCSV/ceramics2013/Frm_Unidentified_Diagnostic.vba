...
On Error GoTo err_cmdAddNew_Click
    ...
    'Me![cboElement].Locked = False
    'Me![cboElement].BackColor = 16777215
...
On Error GoTo err_current
    ...
    'If (Me![txtUnit] = "" Or IsNull(Me![txtUnit])) And (Me![cboElement] = "" Or IsNull(Me![cboElement])) Then
    ...
    Else
        ...
        'Me![cboElement].Locked = True
        'Me![cboElement].BackColor = Me.Section(0).BackColor
    End If
...
Err_go_next_Click:
    ...
    If Err.Number = 2105 Then
        MsgBox "Entry for this Unit already exists"
    Else
