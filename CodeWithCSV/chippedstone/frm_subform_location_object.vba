...
On Error GoTo err_locate
    ...
    Dim current
    current = Forms![frm_CS_stagetwo]![Unit] & ":" & Forms![frm_CS_stagetwo]![Letter] & ":" & Forms![frm_CS_stagetwo]![Number]
...
On Error GoTo err_move
    ...
    Else
        ...
        If Me![CrateLetter] <> "OB" Then
            MsgBox "This particular find is listed as being located in non Chipped Stone Crate. This may mean it has been mis-assigned or " & _
                ...
                "updating the location for you.", vbExclamation, "Raise with Finds Officer"
        Else
            'ok so allow it to be moved within the OB crates
            'get find number from main form to pass as openargs
            Dim current
            current = Forms![frm_CS_stagetwo]![Unit] & ":" & Forms![frm_CS_stagetwo]![Letter] & ":" & Forms![frm_CS_stagetwo]![Number] & ":" & Me![CrateLetter] & Me![CrateNumber]
