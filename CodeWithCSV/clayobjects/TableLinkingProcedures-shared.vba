...
'******************************************************************************
' This module was introduced in version 9 of Excavation db - its checks the table links and
    ...
    For I = 0 To mydb.TableDefs.Count - 1 'loop the tables collection
        ...
        If tmptable.Connect <> "" Then
            ...
            On Error Resume Next
                ...
                myq.sql = "select [Unit No] from [Clay_ClayObjects_phase_1_data] WHERE [Unit No] = 1" 'this is a shared and core table so should always be avail, the record doesn't have to exist
                myq.Execute
