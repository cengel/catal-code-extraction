...
DoCmd.OpenForm "Conserv: Basic Record", acNormal, , , acFormPropertySettings 'open main menu

'refresh the main menu so the version number appears - REPLACE WITH YOUR MENU NAME
Forms![Conserv: Basic Record].Refresh
...
Public Function ConcatRelated(strField As String, strTable As String, Optional strWhere As String, Optional strOrder As String, Optional strSeparator = ", ") As Variant
On Error GoTo err_ConcatRelated

Dim rs, rsMV As DAO.Recordset
Dim strSQL, strOUT As String
Dim lnglen As Long
