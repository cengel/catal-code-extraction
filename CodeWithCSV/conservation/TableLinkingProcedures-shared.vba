    ...
    For I = 0 To mydb.TableDefs.Count - 1 'loop the tables collection
        ...
        If tmptable.Connect <> "" Then
            ...
            On Error Resume Next
                ...
                myq.sql = "select [ConservationRef_Year] from [Conservation_Basic_Record] WHERE [ConservationRef_Year] = '2000'" 'this is a shared and core table so should always be avail, the record doesn't have to exist
                myq.Execute
