...
'***********************************************************************
' Delete Space-Feature Relation on specific space. It seems that a right-click
' functionality to delete records via context menu got lost. Recreating
' with a button
'
' DL 2015
'***********************************************************************
On Error GoTo Err_CmdDelSpaceRelation_Click
    ...
    If Not IsNull(Me![txtIn_Space]) Or Me![txtIn_Space] <> "" Then
            ...
            If permiss = "ADMIN" Or permiss = "exsuper" Then
                ...
                End If
            Else
                'user has no permissions to delete records
...
'MAY 2009 - building numbers are now derived from spaces so after space is changed
'the subform displaying the building numbers must be requeried
