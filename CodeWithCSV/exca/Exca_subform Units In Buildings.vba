...
'May 2009 - building number now comes from space so this form is readonly
'Me![Date changed] = Now()
End Sub
...
' SAJ v9.1
' SAJ May 2009 form always read only now as building number from space
'**********************************************************************
...
'
' SAJ v9.2
' SAJ May 2009 - building number from space, this field is now readonly
'***********************************************************************
...
'
'        'MOVED TO BEFORE UPDATE but quick check here, new 2009 winter - if a user gets number wrong they can't delete it and many then put 0
...
'building 0 keeps appearing and we don't want it so put a check in
'MAY 2009 - building number now comes from space so this field is readonly
