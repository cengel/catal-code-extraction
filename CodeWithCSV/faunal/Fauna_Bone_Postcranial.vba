...
On Error GoTo err_field25

'new season 2009 = for post ex field
PostEx_PostCran_ElementPortion False, Me![Field25]
...
If GetGeneralPermissions = "Admin" Then
    'Me![txtElementPortion].Visible = True 'rissa request change 21july09
    Me![txtElementPortion].Locked = False
    Me![txtElementPortion].BackColor = 16777215
Else
    'Me![txtElementPortion].Visible = False
    Me![txtElementPortion].Locked = True
   Me![txtElementPortion].BackColor = 26367
End If
