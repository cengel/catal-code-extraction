...
'    checkValidAction = CheckIfLOVValueUsed("GroundStone List of Values: FlotPercent", "FlotPercent", Me![txtPercent], "GroundStone 1: Basic Data", "GID", "Percent", "edit", True)
'
'    If checkValidAction = "ok" Then
'        'edit action can go ahead - at present simply offer an input box for this
'        retVal = InputBox("No records refer to this Percent (" & Me![txtPercent] & ") so an edit is allowed." & Chr(13) & Chr(13) & "Please enter the edited Percent that you wish to replace this entry with:", "Enter edited Percent")
'        If retVal <> "" Then
'             Me![txtPercent] = retVal
'        End If
'
...
'
'    'check basic data for fraction field
'    checkValidAction = CheckIfLOVValueUsed("GroundStone List of Values: FlotPercent", "FlotPercent", Me![txtPercent], "GroundStone 1: Basic Data", "GID", "Percent", "delete", True)
'
'    If checkValidAction = "ok" Then
'                'delete action can go ahead - at present simply offer an input box for this
'                retVal = MsgBox("No records refer to this Percent (" & Me![txtPercent] & ") so deletion is allowed." & Chr(13) & Chr(13) & "Are you sure you want to delete " & Me![txtPercent] & " from the list of available Percent?", vbExclamation + vbYesNo, "Confirm Deletion")
