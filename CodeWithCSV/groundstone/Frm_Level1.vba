...
On Error GoTo err_filter
    ...
    If Me![cboFilterUnit] <> "" Then
        Me![frm_subform_level1].Form.RecordSource = "SELECT * FROM Q_GS_Level1_with_Excavation WHERE [Unit] = " & Me![cboFilterUnit]
...
If Me![cboFind] <> "" Then
    DoCmd.GoToControl "frm_subform_level1"
...
If Me.checkPriorityUnits = True Then
    Me![frm_subform_level1].Form.RecordSource = "SELECT * FROM Q_GS_Level1_with_Excavation WHERE [Priority Unit] = 1"
Else
    Me![frm_subform_level1].Form.RecordSource = "Q_GS_Level1_with_Excavation"
End If
...
On Error GoTo Err_cmdgonew_Click
    ...
    DoCmd.GoToControl Me![frm_subform_level1].Name
    DoCmd.GoToRecord , , acNewRec
    DoCmd.GoToControl Me![frm_subform_level1].Form![Unit].Name

    'lock all fields except Unit, Letter, FindNo - CE June 2014
    For Each ctl In Me.frm_subform_level1.Controls
...
On Error GoTo err_Output
    ...
    If Me![frm_subform_level1].Form.[GID] <> "" Then
        DoCmd.OpenForm "Frm_Pop_DataOutLevel1", acNormal, , , acFormPropertySettings, , Me![frm_subform_level1].Form![GID]
    Else
...
Debug.Print Me.frm_subform_level1.Form.CurrentView

    If Me.frm_subform_level1.Form.CurrentView = 1 Then
        Forms![Frm_Level1].[frm_subform_level1].SetFocus
