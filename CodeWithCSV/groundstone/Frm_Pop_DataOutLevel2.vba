...
Dim which, where, sql, rpt
   ...
   If which <> "" Then
        If Me![optgrpData] = 1 Then
            'current only
            where = "[dbo_Groundstone Level 2_2014].[GID] = '" & Me![txtRec] & "'"
        ElseIf Me![optgrpData] = 2 Then
            ...
            If Me![cboStart] = "" Or Me![cboEnd] = "" Then
                ...
                Exit Sub
            Else
                where = "[dbo_Groundstone Level 2_2014].[GID] BETWEEN '" & Me![cboStart] & "' AND '" & Me![cboEnd] & "'"
            End If
        ...
        sql = "SELECT * FROM [Q_GS_Level2_with_Excavation]"
        ...
        If which = "report" Then
            ...
            DoCmd.Close acForm, "Frm_Pop_DataOutLevel2"
...
If Not IsNull(Me.OpenArgs) Then
    ...
    Me![cboStart].RowSource = "SELECT DISTINCT [GID] FROM [dbo_Groundstone Level 2_2014] ORDER BY [GID];"
    Me![cboEnd].RowSource = "SELECT DISTINCT [GID] FROM [dbo_Groundstone Level 2_2014] ORDER BY [GID];"
