...
If username <> "" And pwd <> "" Then
    ...
    For I = 0 To mydb.TableDefs.Count - 1 'loop the tables collection
        ...
        If tmptable.Connect <> "" Then
            ...
            'new 2010
            Forms![Login]![lblMsg] = "System is contacting the server"
            ...
            Else
                ...
                'new 2010
                Forms![Login]![lblMsg] = "System is refreshing the link to the server"
                
                tmptable.Connect = tmptable.Connect & ";UID=" & username & ";PWD=" & pwd
                tmptable.RefreshLink
                
                'new 2010
                Forms![Login]![lblMsg] = "Refresh Complete"
            End If
...
End If
Forms![Login]![lblMsg] = "Defining permissions"
