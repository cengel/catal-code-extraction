...
On Error GoTo err_move
    ...
    Else
        ...
        Else
            ...
            'get find number from main form to pass as openargs
            Dim current
            current = Forms![Frm_Basic_Data]![frm_subform_basic_2013].Form![Unit] & ":" & Forms![Frm_Basic_Data]![frm_subform_basic_2013].Form![Lettercode] & ":" & Forms![Frm_Basic_Data]![frm_subform_basic_2013].Form![FindNumber] & ":" & Me![CrateLetter] & Me![CrateNumber]
...
' set this all to false, because moving is now happening in the Finds DB
